                            ...
                            <div class="terms_area">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="flexCheckChecked3">
                                        I have read and agree to the website <a href="{{ route('terms-and-conditions-page') }}">terms and conditions *</a>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="wsus__check_form p-3">
                            <form action="{{route('user.checkout.address.create')}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <input type="text" placeholder="Barangay *" name="barangay" value="{{old('barangay')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                    ...
                                    <div class="col-md-12">
                                        <div class="wsus__check_single_form">
                                            <input type="text" placeholder="Postal Code *" name="postal_code" value="{{old('postal_code')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="wsus__check_single_form">
