                      ...
                      <div class="row">
                        ...
                        <div class="col-10">
                          <div class="tab-content" id="nav-tabContent">
                            ...
                            @include('Staff.advertisement.homepage-banner-one')

                            @include('Staff.advertisement.homepage-banner-two')

                            @include('Staff.advertisement.homepage-banner-three')

                            @include('Staff.advertisement.homepage-banner-four')

                            @include('Staff.advertisement.product-page-banner')

                            @include('Staff.advertisement.cart-page-banner')
