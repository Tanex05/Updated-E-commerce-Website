          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{route('footer-grid-three.change-title')}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="col-4">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{route('footer-grid-three.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Create New</a>
                    </div>
                  </div>
                  <div class="card-body">
                    {{ $dataTable->table() }}
    ...
    <script>
        $(document).ready(function(){
            $('body').on('click', '.change-status', function(){
                ...
                $.ajax({
                    url: "{{route('footer-grid-three.change-status')}}",
                    method: 'PUT',
                    data: {
                        status: isChecked,
                        id: id
