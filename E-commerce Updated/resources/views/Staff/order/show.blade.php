                      ...
                      <div class="col-md-6">
                        <address>
                          <strong>Billed To: </strong> <br>
                            <b>Account Name:</b> {{$userName}}<br>
                            <b>Name:</b> {{$address->name}}<br>
                            <b>Email: </b> {{$address->email}}<br>
                            <b>Phone:</b> {{$address->phone}}<br><br>
                           <strong>Shipping Address:</strong><br>
                            <b>Address:</b> {{$address->address}},<br>
                            <b>Region:</b> {{$address->region}}<br>
                            <b>Province:</b> {{$address->province}}<br>
                            <b>Barangay:</b> {{$address->barangay}}<br>
                            <b>City:</b> {{$address->city}}<br>
                            <b>Postal Code:</b> {{ $address->postal_code }}<br>
                        </address>
                      </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="order_status" id="order_status" data-id="{{$order->id}}" class="form-control">
                                    @foreach (config('order_status.order_status_staff') as $key => $orderStatus)
