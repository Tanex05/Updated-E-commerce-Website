...
class FooterSocialController extends Controller
{
    ...
    {
        return $dataTable->render('Staff.footer.footer-socials.index');
    }
    ...
    {
        return view('Staff.footer.footer-socials.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('Staff.footer.footer-socials.edit', compact('footer'));
    }
