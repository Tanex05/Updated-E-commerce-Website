<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">
    <div class="card border">
        <div class="card-body">
            <form action="{{route('homepage-banner-section-three')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <h5>banner one</h5>
                ...
                <div class="form-group">
                    ...
                    <label>Banner Image (630x560)</label>
                ...
                <div class="form-group">
                    ...
                    <label>Banner Image (625x 270)</label>
